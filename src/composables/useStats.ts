...
export async function createSpectacle(s: SpectacleRequest): Promise<Spectacle> {
  return apiCall<Spectacle>('/spectacles', { method: 'POST', body: s })
}

export async function updateSpectacle(id: number, s: SpectacleRequest): Promise<Spectacle> {
